	...
	def placeQueueList(self, screen, iScreenW, iScreenH, items, currentIndex, groupByIndex, groupLabels, itemIcons):
		...
		while i < len(items) and iRows < iMaxRows:
			...
			if i == currentIndex:
				...
				szLabel = u"> " + szLabel
				szLabel = sasFontTagLabel.bold + szLabel + SAS_FONT_TAG_CLOSE
			else:
