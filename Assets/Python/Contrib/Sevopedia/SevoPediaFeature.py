...
# With some modifications to make it work for/in AdvCiv-SAS


from CvPythonExtensions import *
import CvUtil
import ScreenInput
# <!-- custom: seems unneeded now
...
class SevoPediaFeature:
	...
	def interfaceScreen(self, iFeature):
		# <!-- custom: seems this variable is never called, commenting-it out (may even remove it?)
