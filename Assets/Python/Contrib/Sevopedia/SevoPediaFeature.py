...
class SevoPediaFeature:
	...
	# <!-- custom: codex change: populate feature panels using AI-assisted refactor. -->
		...
		if self.iFeature == iIce:
			for iUnit in xrange(gc.getNumUnitInfos()):
				...
				unitInfoDomain = unitInfo.getDomainType()
					...
					# <!-- custom: codex change: allow any-domain units on Ice Cap only if canMoveAllTerrain. -->
					# <!-- custom: codex change: broaden Ice Cap eligibility using canMoveAllTerrain. -->
