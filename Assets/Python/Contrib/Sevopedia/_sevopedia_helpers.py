...
# <!-- custom: working-functioning anyways etc (see output example below after function code anyways etc) debug for flavor, nowarprob, contact , and memory fields -->
def debugPrintLeaderHeadInfoFlavorNowarattitudeprobATContactMemoryBBAIvictoryweights(iLeader, gc):
    print("==== FLAVORS ====")
