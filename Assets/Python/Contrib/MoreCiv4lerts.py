	...
	##Added "else: pass" code to diagnose strange results - might be related to indent issues
		...
		if (self.getCheckForDomVictory() and gc.getGame().isVictoryValid(DomVictory)):
			...
			if (self.getCheckForDomPopVictory()):
				...
				# <!-- custom: replace "<>" with "!=" as per pylance error "Operator "<>" is not supported in Python 3; use "!=" instead" and asking chatgpt thanks to my prompt too to be sur ei mean anwyays etc thanks to chatgpt and me and those who read this or nto or and all or not or yes or anyways etc anyways etc anyways etc -->
