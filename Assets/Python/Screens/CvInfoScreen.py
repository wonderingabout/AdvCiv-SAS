...
#BUG: Change Graphs - end
	...
	def buildHistoryCache(self, bForceRebuild = False):
		...
		aRawEntries = CyGame().getReplayMessagesFiltered(self.iActiveTeam, self.bRevealAll)
		for tEntry in aRawEntries:
			szText = tEntry[0]
			eColor = tEntry[1]
			entries.append(localText.changeTextColor(szText, eColor))
