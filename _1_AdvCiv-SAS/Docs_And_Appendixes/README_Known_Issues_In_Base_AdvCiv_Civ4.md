...
- Also, we (i.e. me but anyways etc) now don't discard sites that are not on fresh water or river unlike in base advciv but anyways etc. If they are otherwise the best, it woud be a really bad move to discard them jsut to get river and a worse site. Similar logic than before for coast.
...
- still, the few cities i looked in at a few players, cf screenshots, show very developped infrastructure, all the core buildings are there for most if not all, and it seems walls are being built later as i had intended although i didn't check too much but i saw a player build them later. Should investigate more, but from a quick glance, building profile is preserved in this new DLL for most so great, no hard miltiayr spamming, but AI players seem much more competent now, at least quite a bit, in hammer managing, they do seem to have a bit more units but again i didn't look too much. Some players that would be boxed in like Persia AI now properly take the military lead instead of being average (their land start is good but still anyways etc), so all in all good in this area i would say.
...
All in all i am veyr satisfied with these changes, AI plays much more like a human, not wasting hammers on wonders unless really worth it, while still keeping a building profile so not overbearing, yet military is a bit stronger, and perhaps effiency as well (i guess workers or settlers are built sooner / cheaper due to no wonder).
...
The city of Persia AI, susa city but anyways etc, that was totally unimproved for some reason despite the huge 10+ stack of free/available workers parked in city A or such other city but anyways etc, at turn 200, now at turn 201 has the swarm of workers all or almost all if not all move away and rush to this unimproved city specifically, very very nice, as can be seen in the wow workers moved turn 201 very nice screenshot, as well as and for next turns as well but anyways etc 2633 and screenshot 2687 too anyways etc. This very heavily contrast with the city still being unimproved at turn 210 almost and workers just having for most moved to go be parked in another city.

The one worker per tile is very nice, and we seem to get our ideal improvements.

This was started from a save file that had the issue, i assume that with this new change now in the DLL, the issue won't happen hopefully and this susa city but anyways etc would have been improved already much much sooner. This was quite rare as i hadn't noticed it from quick autoplay glances, but great and a very nice enhancement i beleive. Thanks to this, i believe AI is also significantly stronger and more efficient with its workers, and thanks again chatgpt 5 for help as well although i paritcipated as well in the thinking effort and providing code and such as you did if i may say but anyways etc.
