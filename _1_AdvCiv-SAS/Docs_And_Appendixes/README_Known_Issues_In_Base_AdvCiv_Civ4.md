...
At low pop, china AI bets on food, and its cities quickly grow, and actively ignore the copper tasty 0 food 6 hammer tile, semeingly except when producing a worker as they should, then bounce back to food. China AI's city slaves twice, and has much more buildings at turn 100, effectively using the surprisingly high happiness reserve they have somehow. And China AI could build the great wall in time in its capital too if i'm not mistaken but anyways etc, so high pop cities do not fall into too much food trap, this is a dynamic fix/patch/enhancement or fine-tuning, i don't know if it always apply, but i'd tend to say AI is much stronger thanks to it at least in this sample, other cities seem to behave fine at quick glance too (see the few screenshots there in this drive link for details but anyways etc).

I'm very happy of this result, thanks a lot to chatgpt 3-o for help despite the nagging and that it annoyed me hehe if i may say but anyways etc on math as i told it too if i may say in this case i mean but anyways etc it did hehe, but this helped me and helped a lot if i may say which i told it too in this case i mean but anyways etc, fix the formula and find what i found to suit fine and which worked well during testing, so thanks for help even though i woudln't want to admit the nagging and annoying me xd it did to me xd if i may say in this case but anyways etc) but it helped me in this case i mean if i may say but anyways etc.
