...
void CyGlobalContextPythonInterface2(python::class_<CyGlobalContext>& x)
{
	...
	x
		...
		.def("getModSourceDirtyState", &CyGlobalContext::getModSourceDirtyState, "int ()" )
		.def("getModSourceDirtyFileCount", &CyGlobalContext::getModSourceDirtyFileCount, "int ()" )
		.def("getModSourceDirtyFiles", &CyGlobalContext::getModSourceDirtyFiles, "string ()" )
