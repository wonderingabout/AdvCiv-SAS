...
<img src="./_1_AdvCiv-SAS/Images/advisors/0.517_world_advisor (1).JPG" alt="0.517_world_advisor (1).JPG" width="250"></img>
<img src="./_1_AdvCiv-SAS/Images/advisors/0.517_world_advisor (2).JPG" alt="0.517_world_advisor (2).JPG" width="250"></img>
<img src="./_1_AdvCiv-SAS/Images/advisors/0.517_world_advisor (3).JPG" alt="0.517_world_advisor (3).JPG" width="250"></img>
<img src="./_1_AdvCiv-SAS/Images/advisors/0.517_world_advisor (4).JPG" alt="0.517_world_advisor (4).JPG" width="250"></img>
...
<img src="./_1_AdvCiv-SAS/Images/advisors/0.518_info_screen (6).JPG" alt="0.518_info_screen (6).JPG" width="250"></img>
<img src="./_1_AdvCiv-SAS/Images/advisors/0.519_victory_screen (1).JPG" alt="0.519_victory_screen (1).JPG" width="250"></img>
<img src="./_1_AdvCiv-SAS/Images/advisors/0.519_victory_screen (2).JPG" alt="0.519_victory_screen (2).JPG" width="250"></img>
<img src="./_1_AdvCiv-SAS/Images/advisors/0.519_victory_screen (3).JPG" alt="0.519_victory_screen (3).JPG" width="250"></img>
<img src="./_1_AdvCiv-SAS/Images/advisors/0.519_victory_screen (4).JPG" alt="0.519_victory_screen (4).JPG" width="250"></img>
...
BBAI_LOG_SETTINGS SAS_BBAI_LOG_ENABLE=1 SAS_BBAI_LOG_USE_TIMESTAMPED_FILENAME=1 SAS_BBAI_PLAYER_LOG_LEVEL=3 SAS_BBAI_TEAM_LOG_LEVEL=3 SAS_BBAI_WAR_LOG_LEVEL=0 SAS_BBAI_CITY_LOG_LEVEL=0 SAS_BBAI_MILITARY_PRODUCTION_LOG_LEVEL=0 SAS_BBAI_SPACE_PRODUCTION_LOG_LEVEL=0 SAS_BBAI_LIMITED_PROJECT_PRODUCTION_LOG_LEVEL=0 SAS_BBAI_CITIZEN_LOG_LEVEL=0 SAS_BBAI_UNIT_LOG_LEVEL=0 SAS_BBAI_OVERSEAS_TRANSPORT_LOG_LEVEL=0 SAS_BBAI_GREAT_GENERAL_LOG_LEVEL=0 SAS_BBAI_SETTLER_LOG_LEVEL=0 SAS_BBAI_FOUND_LOG_LEVEL=0 SAS_BBAI_EVACUATION_LOG_LEVEL=0 SAS_BBAI_WORKER_LOG_LEVEL=0 SAS_BBAI_WORKER_SEA_LOG_LEVEL=0 SAS_BBAI_MAP_LOG_LEVEL=0 SAS_BBAI_DEAL_CANCEL_LOG_LEVEL=0 SAS_BBAI_CULTURE_LOG_LEVEL=0 SAS_BBAI_SCORE_LOG_INTERVAL_TURNS_UNSCALED_GAMESPEED=100
...
For example, `SASGameRecord_*.log` starts with lifecycle, provenance and run-setup rows before adding RNG/state checkpoints and compact turn snapshots. These selected rows come from one revision-71 repeated-load validation run; gaps in `seq` mean that unrelated intervening rows are omitted:

```log
GAME_RECORD_SAVE_LOADED seq=1 processUtc=20260910T152849Z utc=20260910T153020Z logFile="SASGameRecord_20260910T153020Z_load2.log" turn=0 elapsed=0 year=-50000 scenario=0 activePlayer=0 activeCivilization=CIVILIZATION_PORTUGAL activeHandicap=HANDICAP_MONARCH playersDefined=16 playersAlive=16 playersEverAlive=16 humans=1 sessionWallMilliseconds=0
...
GAME_RECORD_GAME_SETTINGS seq=3 mapScript="Pangaea" map=94x64 landHeavy=1 navalHeavy=0 world=WORLDSIZE_HUGE climate=CLIMATE_TEMPERATE seaLevel=SEALEVEL_MEDIUM gameSpeed=GAMESPEED_NORMAL startEra=ERA_ANCIENT calendar=CALENDAR_DEFAULT startTurn=0 startYear=-50000 gameHandicap=HANDICAP_MONARCH maxTurns=500 targetScore=0 advancedStartConfiguredPoints=-1 advancedStartXmlDefaultPoints=-1 victories=VICTORY_SCORE,VICTORY_TIME,VICTORY_CONQUEST,VICTORY_DOMINATION,VICTORY_CULTURAL,VICTORY_SPACE_RACE,VICTORY_DIPLOMATIC options=GAMEOPTION_AGGRESSIVE_AI,GAMEOPTION_NO_EVENTS
GAME_RECORD_GAME_RNG seq=10 mapRandState=2132533305 syncRandState=4007282559 initialMapRandSeed=36564287 initialSyncRandSeed=36564287
GAME_RECORD_MOD_CONTEXT seq=11 displayName="AdvCiv-SAS" folderName="AdvCiv-SAS" modPath="Mods\\AdvCiv-SAS\\"
GAME_RECORD_SOURCE_CONTEXT seq=12 recordRevision=71 version="6441" commit="e7c316b1988fca98dc8baa1271ab47049b26d2d0" shortCommit="e7c316b198" branch="main" commitDate="2026-09-10T15:11:43+02:00" metadataSource="git" dirty=1 dirtyTrackedCount=9 dirtyFiles="[ M] Assets/CvGameCoreDLL.dll; [ M] Assets/XML/GlobalDefines_advciv_sas.xml; [M ] CvGameCoreDLL/SASGameRecordLog.cpp; [M ] CvGameCoreDLL/SASGameRecordLog.h; [M ] LLM_Helpers/compare_sasgamerecord_rng.py; [ M] _1_AdvCiv-SAS/Docs/README_Known_Issues.md; [M ] _1_AdvCiv-SAS/Docs/README_Main_Changes_Guide.md; [M ] _1_AdvCiv-SAS/Docs/README_SASGameRecord_Revisions.md; [ M] _1_AdvCiv-SAS/Docs/Source_Analysis/cpp_file_audit_album.txt"
GAME_RECORD_DLL_CONTEXT seq=13 build=Debug-opt moduleFound=1 fileReadable=1 fileSizeBytes=13295616 dllFingerprint=FNV1A64:17395FBB1D972B0D dllLastWriteUtc=20260910T151138.923Z peTimestampRaw=1789053090 peTimestampUtc=20260910T151130Z fassertEnabled=0 debugDefine=0 ndebugDefine=1
GAME_RECORD_LOG_SETTINGS seq=16 SAS_GAME_RECORD_LOG_LEVEL=3 SAS_GAME_RECORD_INTERVAL_TURNS_UNSCALED_GAMESPEED=10 SAS_GAME_RECORD_LOG_USE_TIMESTAMPED_FILENAME=1 SAS_AIAUTOPLAY_AUTO_DISMISS_INFORMATIONAL_POPUPS_ENABLE=1 SAS_GAME_RECORD_MAP_ASCII_MAX_WIDTH=160 SAS_GAME_RECORD_MAP_ASCII_MAX_HEIGHT=120 SAS_GAME_RECORD_MAP_ASCII_HORIZONTAL_CHARS_PER_CELL=2 SAS_GAME_RECORD_MAP_ASCII_OVERVIEW_1_SCALE_PERCENT=25 SAS_GAME_RECORD_MAP_ASCII_OVERVIEW_2_SCALE_PERCENT=50 SAS_GAME_RECORD_MAP_ASCII_NATIVE_GEOGRAPHY_ENABLE=1 SAS_GAME_RECORD_MAP_ASCII_GEOGRAPHY_ENABLE=1 SAS_GAME_RECORD_MAP_ASCII_TERRAIN_ENABLE=1 SAS_GAME_RECORD_MAP_ASCII_RIVER_ENABLE=1 SAS_GAME_RECORD_MAP_ASCII_BONUS_ENABLE=1 SAS_GAME_RECORD_MAP_ASCII_FEATURE_ENABLE=1 SAS_GAME_RECORD_MAP_ASCII_POLITICAL_ENABLE=1 SAS_GAME_RECORD_TRADE_MARKET_ENABLE=1 SAS_GAME_RECORD_TRADE_MARKET_BONUS_GPT_QUOTES_ENABLE=1 SAS_GAME_RECORD_TRADE_MARKET_AI_TECH_VALUES_ENABLE=1 SAS_GAME_RECORD_PERFORMANCE_METRICS_ENABLE=1 SAS_GAME_RECORD_SYSTEM_CONTEXT_LEVEL=2
GAME_RECORD_RNG_CHECKPOINT seq=348 turn=0 reason=SAVE_LOADED rngFingerprintSchema=1 mapSessionStartState=2132533305 mapIntervalStartState=2132533305 mapState=2132533305 mapIntervalCalls=0 mapSessionCalls=0 mapIntervalNullMessageCalls=0 mapSessionNullMessageCalls=0 mapIntervalExternalCalls=0 mapSessionExternalCalls=0 mapIntervalDeterministicRangeCalls=0 mapSessionDeterministicRangeCalls=0 mapIntervalSeedSets=0 mapSessionSeedSets=0 mapIntervalStreamFingerprint=FNV1A32:811C9DC5 mapSessionStreamFingerprint=FNV1A64:CBF29CE484222325 mapIntervalCallFingerprint=FNV1A32:811C9DC5 mapSessionCallFingerprint=FNV1A64:CBF29CE484222325 syncSessionStartState=4007282559 syncIntervalStartState=4007282559 syncState=4007282559 syncIntervalCalls=0 syncSessionCalls=0 syncIntervalNullMessageCalls=0 syncSessionNullMessageCalls=0 syncIntervalExternalCalls=0 syncSessionExternalCalls=0 syncIntervalDeterministicRangeCalls=0 syncSessionDeterministicRangeCalls=0 syncIntervalSeedSets=0 syncSessionSeedSets=0 syncIntervalStreamFingerprint=FNV1A32:811C9DC5 syncSessionStreamFingerprint=FNV1A64:CBF29CE484222325 syncIntervalCallFingerprint=FNV1A32:811C9DC5 syncSessionCallFingerprint=FNV1A64:CBF29CE484222325
GAME_RECORD_STATE_CHECKPOINT seq=349 turn=0 reason=SAVE_LOADED coverage=CORE everAliveTeamCount=17 everAlivePlayerCount=17 cityCount=0 unitCount=46 groupCount=46 plotCount=6016 dealCount=0 gameFingerprint=FNV1A64:2BCB082F269C3C57 teamsFingerprint=FNV1A64:344FFF09C2F0C527 playersFingerprint=FNV1A64:66ADEA3764F01C0D citiesFingerprint=FNV1A64:CBF29CE484222325 unitsFingerprint=FNV1A64:713ACE6B674DAC94 groupsFingerprint=FNV1A64:F61BF5C8BF2321BC plotsFingerprint=FNV1A64:F5D54898306AFDA6 dealsFingerprint=FNV1A64:CBF29CE484222325 combinedFingerprint=FNV1A64:6D2A9AD65327645C computeMilliseconds=1
GAME_RECORD_ACTION seq=351 turn=0 type=AUTOPLAY_STARTED oldTurnsLeft=0 newTurnsLeft=101 activePlayer=0 changePlayerStatus=1 requestId=1 requestedTurns=101 completedTurns=0 elapsedGameTurns=0 sessionWallMilliseconds=12146 autoplayWallMilliseconds=0 startTurn=0 startElapsed=0 startPlayer=0 activePlayerChanges=0 totalActivePlayerChanges=0 endCause=-
GAME_RECORD_TURN_BEGIN seq=752 turn=10 reason=interval elapsed=10 year=-18000 playersAlive=16 teamsAlive=16 totalCities=16 totalPopulation=16 utc=20260910T153035.838Z sessionWallMilliseconds=15705 snapshotIntervalWallMilliseconds=15705 performanceMetricsEnabled=1 processForegroundAtSnapshot=1 processWindowMinimizedAtSnapshot=0 processWorkingSetKB=598232 processPeakWorkingSetKB=697868 processPagefileUsageKB=525268 systemMemoryLoadPercent=55 processAvailableVirtualMB=2298
GAME_RECORD_TURN_END seq=1486 turn=10 reason=interval sessionWallMilliseconds=15713 snapshotWallMilliseconds=8
```
