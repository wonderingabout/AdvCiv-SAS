...
```log
GAME_RECORD_NEW_GAME_STARTED processUtc=20260830T221354Z utc=20260830T221419Z logFile="SASGameRecord_20260830T221419Z_new1.log" turn=0 elapsed=0 year=-50000 scenario=0 activePlayer=0 activeCivilization=CIVILIZATION_CELT activeHandicap=HANDICAP_MONARCH playersDefined=16 playersAlive=16 playersEverAlive=16 humans=1 sessionWallMilliseconds=3771
GAME_RECORD_GAME_SETTINGS mapScript="Hemispheres" map=102x72 landHeavy=1 navalHeavy=0 world=WORLDSIZE_HUGE climate=CLIMATE_TEMPERATE seaLevel=SEALEVEL_MEDIUM gameSpeed=GAMESPEED_NORMAL startEra=ERA_ANCIENT calendar=CALENDAR_DEFAULT startTurn=0 startYear=-50000 gameHandicap=HANDICAP_MONARCH maxTurns=500 targetScore=0 advancedStartConfiguredPoints=-1 advancedStartXmlDefaultPoints=-1 victories=VICTORY_SCORE,VICTORY_TIME,VICTORY_CONQUEST,VICTORY_DOMINATION,VICTORY_CULTURAL,VICTORY_SPACE_RACE,VICTORY_DIPLOMATIC options=GAMEOPTION_AGGRESSIVE_AI,GAMEOPTION_NO_EVENTS sessionWallMilliseconds=3771
GAME_RECORD_MAP_OPTIONS count=3 hidden=0 scriptAvailable=1 sessionWallMilliseconds=3773
GAME_RECORD_MAP_OPTION index=0 hidden=0 value=1 scriptDefault=1 isScriptDefault=1 description="Normal Continents" scriptDefaultDescription="Normal Continents" sessionWallMilliseconds=3773
GAME_RECORD_WAR_AI_SETTINGS warPeaceAI=UWAI uwaiMode=FULL engineAggressiveAI=1 USE_KMOD_AI_NONAGGRESSIVE=0 DISABLE_UWAI=0 UWAI_IN_BACKGROUND=0 sessionWallMilliseconds=3773
GAME_RECORD_MOD_CONTEXT displayName="AdvCiv-SAS" folderName="AdvCiv-SAS" modPath="Mods\\AdvCiv-SAS\\" sessionWallMilliseconds=3773
GAME_RECORD_SLOT_CONSTANTS MAX_CIV_PLAYERS=48 MAX_PLAYERS=49 BARBARIAN_PLAYER=48 MAX_CIV_TEAMS=48 MAX_TEAMS=49 BARBARIAN_TEAM=48 NO_PLAYER=-1 NO_TEAM=-1 sessionWallMilliseconds=3773
GAME_RECORD_ACTION turn=0 type=DEBUG_MODE_CHANGED old=0 new=1 activePlayer=0 sessionWallMilliseconds=12340
GAME_RECORD_ACTION turn=0 type=AUTOPLAY_STARTED oldTurnsLeft=0 newTurnsLeft=51 activePlayer=0 changePlayerStatus=1 requestId=1 requestedTurns=51 completedTurns=0 elapsedGameTurns=0 autoplayWallMilliseconds=0 startTurn=0 startElapsed=0 startPlayer=0 activePlayerChanges=0 totalActivePlayerChanges=0 endCause=- sessionWallMilliseconds=22787
GAME_RECORD_TURN_BEGIN turn=10 reason=interval elapsed=10 year=-18000 playersAlive=16 teamsAlive=16 totalCities=16 totalPopulation=17 utc=20260830T221446.268Z snapshotIntervalWallMilliseconds=27139 performanceMetricsEnabled=1 processForegroundAtSnapshot=1 processWindowMinimizedAtSnapshot=0 processWorkingSetKB=574328 processPeakWorkingSetKB=574336 processPagefileUsageKB=513184 systemMemoryLoadPercent=51 processAvailableVirtualMB=2454 sessionWallMilliseconds=27140
GAME_RECORD_ACTION turn=35 type=AUTOPLAY_ENDED oldTurnsLeft=16 newTurnsLeft=0 activePlayer=0 changePlayerStatus=1 requestId=1 requestedTurns=51 completedTurns=35 elapsedGameTurns=35 autoplayWallMilliseconds=10649 startTurn=0 startElapsed=0 startPlayer=0 activePlayerChanges=0 totalActivePlayerChanges=0 endCause=USER_INTERRUPTED sessionWallMilliseconds=33436
```
