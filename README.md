...
Here is a view (current) of the military tree you can expect/find in this AdvCiv-SAS mod below. I tweaked the existing one of base AdvCiv/civ4 BTS for historical accuracy and gameplay diversity:
...
note2: an accuracy note hehe now that i gained enlightenment about what the AI which i still value lot i think and like if i may say does thanks a lot even though bit painful but is the truth hehe so thanks lot but anyways etc... :)
