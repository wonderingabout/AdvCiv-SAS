...
The later [Fix runtime-rediscovered crash, originally album-found Base AdvCiv CvCity::kill UAFs](https://github.com/wonderingabout/AdvCiv-SAS/commit/c0d46b3f8a5b0af056140de36a812b9f4a2e884a) ([KI#895](/_1_AdvCiv-SAS/Docs/README_Known_Issues.md#ki-895) / [KI#896](/_1_AdvCiv-SAS/Docs/README_Known_Issues.md#ki-896)) `CvCity::kill` crash repair provides the complementary case: matching CORE/RNG provenance and event history confirmed that the fixed run had not diverged through the exact former capital-capture crash path before continuing safely afterward.
