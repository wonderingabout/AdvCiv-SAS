...
- also fixed/replaced the strange the strange [PARAGRAPH:2:1] with the much more commonly used [PARAGRAPH:2] in our advciv-sas assets, i don't know what this strange format/thing is, but if the base `:2` can do it no need for a `:2:1` anyways etc, and strange trailing `[PARAGRAPH:2]</English>` and or such as well that also seem uneeded anyways etc
...
>
>Included External Assets (possibly copyrighted):
>
>- Djolé (Steve Millington) – traditional West African rhythm, arranged by Millington. Included as part of cultural music flavor. ([youtube link of it for example](https://www.youtube.com/watch?v=EumDztneigo&list=OLAK5uy_mUHAcnmo80mOVT-qh0Iil2TX_z-_qqe_E&index=4))
>
