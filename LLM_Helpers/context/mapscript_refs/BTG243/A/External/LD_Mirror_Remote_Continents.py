#	FILE:	 LD_Mirror_Continets.py
#	AUTHOR:  Leszek Deska (LDeska) ldeska@yahoo.com
# Klub Anonimowych Civ-maniaków http://forum.kac.org.pl/
# Used parts of original Mirror.py script made by Bob Thomas (Sirian)
