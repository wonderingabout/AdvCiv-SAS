...
#   - <!-- custom: Output file is used for external to Civ4 leader data analysis and display, for example a .csv comparing all leaders's values table generated by flatten_leaders_data_to_csv.py (with a corresponding .md legend as well at least as of now anyways etc) -->
