...
def beforeGeneration():
	...
	if iPlayers > 18 or iPlayers >= len(configs):
		return 0
...
def findStartingPlot(argsList):
	...
	def isValid(playerID, x, y):
		...
		# Clamp the center inside the two-plot safety envelope first so every configured window contains its own center. See KI#295.
