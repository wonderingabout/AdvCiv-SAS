...
def assignStartingPlots():
	...
	# Derive the actual two team IDs from the shuffled participating players, then verify equal membership before assigning either side. See KI#294.
	...
	else: # We will put team one on the left.
	...
	for playerIndex in range(len(primaryPlayers)):
		...
		if startPlot < 0:
			...
			# Roll back any provisional mirrored pairs and delegate the complete assignment instead. See KI#294.2. (GPT-5.6-Sol) -->
