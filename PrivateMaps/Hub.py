...
def beforeGeneration():
	...
	if iPlayers < 2:
		...
		bSuccessFlag = True
	# <!-- custom: Keep Hub map shape for very high player counts by generating only up to the script-supported template count; use default start placement for overflow players. (GPT-5.3-Codex) -->
